...
<body>
	...
	<article>
		<%-- <form:form method="post" action="changePwd">
			<table>
				<tr>
		...
		<div>
			<form:form method="post" action="changePwd">
				...
				<input type="text" name="password" placeholder="Your Old password.." required="required">
				<label for="password">New Password</label>
				<input type="password" name="cpassword" placeholder="Your New password.." required="required">
				<label for="password">Confirm new Password</label>
				<input type="password" name="cpassword" placeholder="Confirm New password.." required="required">
